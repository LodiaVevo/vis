...
const tag = 'STRG'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '820185432565350440') //erkek rol id
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '820186505095675964')//erkek rol 2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '820190278777831434')//kayıtsız id
const genelchat = message.guild.channels.cache.find(c => c.id === '820179075696033803')//genelchat id
