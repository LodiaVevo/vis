...
if(!['820184993355399199'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = 'STRG'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '820185434734067744') //kadın rol id
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '820186505389277195')//kadın rol2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '820190278777831434')//kayıtsız rol id
const genelchat = message.guild.channels.cache.find(c => c.id === '820179075696033803')//genel chat id
const savelog = message.guild.channels.cache.find(c => c.id === '820045319092830218')//savelog id
